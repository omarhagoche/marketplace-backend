...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <div class="form-group row ">
        ...
        <div class="col-9">
            {!! Form::text('phone_number', isset($user) ? $user->phone_number : '', ['class' => 'form-control ', 'placeholder' => trans('lang.user_phone_number_placeholder'), 'minlength' => 9,'maxlength' => 9, 'pattern' => "[9](1|2|4|5)[0-9]{7}"]) !!}
            <div class="form-text text-muted">
...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    @isset($user->latitude)
        ...
        <div class="form-group row justify-content-center">
            <div class="col-auto">
                <a href="https://maps.google.com/?q={{ $user->latitude }},{{ $user->longitude }}" target="_blank"
                    class="btn btn-{{ setting('theme_color') }}">Location on google map</a>
            </div>
        </div>
    @endisset
...
<div class="form-group col-12 text-right">
    <button type="submit" class="btn btn-{{ setting('theme_color') }}"><i class="fa fa-save"></i>
        {{ trans('lang.save') }} {{ trans('lang.user') }}</button>
