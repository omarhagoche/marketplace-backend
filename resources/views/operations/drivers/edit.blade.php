    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item"><a href="{!! route('operations.drivers.index') !!}">{{trans('lang.driver_plural')}}</a>
          </li>
  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        ...
        @can('drivers.create')
        <li class="nav-item">
          <a class="nav-link" href="{!! route('operations.drivers.create') !!}"><i class="fa fa-plus mr-2"></i>{{trans('lang.driver_create')}}</a>
        </li>
        @endcan
        <li class="nav-item">
    ...
    <div class="card-body">
      {!! Form::model($driver, ['route' => ['operations.drivers.update', $driver->id], 'method' => 'patch']) !!}
      <div class="row">
        @include('operations.drivers.fields')
      </div>
      {!! Form::close() !!}
      <div class="clearfix"></div>
    </div>
