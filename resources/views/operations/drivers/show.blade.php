            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('operations/') }}"><i class="fa fa-dashboard"></i>
                                {{ trans('lang.dashboard') }}</a></li>
                        <li class="breadcrumb-itema ctive"><a
                                href="{!! route('operations.drivers.index') !!}">{{ trans('lang.driver_plural') }}</a>
                        </li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        ...
        <div class="card">
            <div class="card-header">
                <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
                    <li class="nav-item">
                        <a class="nav-link" href="{!! route('operations.drivers.index') !!}"><i
                                class="fa fa-list mr-2"></i>{{ trans('lang.driver_table') }}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="{!! route('operations.drivers.create') !!}"><i
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-12 text-right">
                        <a href="{!! route('operations.drivers.index') !!}" class="btn btn-default"><i class="fa fa-undo"></i>
                            {{ trans('lang.back') }}</a>
                    </div>
                </div>
