<ul class="nav nav-tabs align-items-end card-header-tabs w-100">
    ...
    <li class="nav-item">
        <a class="nav-link  {{ Route::is('operations.users.profile.statistics') ? 'active' : '' }}" href="{!! url()->current().'/favorites' !!}"><i class="fa fa-star mr-2"></i>{{trans('lang.client_favorites')}}</a>
    </li>
    <li class="nav-item ">
