...
@php
$searchFields = [['name' => 'name', 'data-column' => 1, 'title' => trans('lang.restaurant'), 'type' => 'text', 'value' => request('name')], ['name' => 'address', 'data-column' => 2, 'title' => trans('lang.restaurant_address'), 'type' => 'text', 'value' => request('address')], ['name' => 'phone', 'data-column' => 3, 'title' => trans('lang.restaurant_phone'), 'type' => 'text', 'value' => request('phone')], ['name' => 'moblie', 'data-column' => 4, 'title' => trans('lang.restaurant_mobile'), 'type' => 'text', 'value' => request('moblie')]];
@endphp
