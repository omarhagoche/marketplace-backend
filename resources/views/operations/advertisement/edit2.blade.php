...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">{{trans('lang.advertisement_plural')}}<small class="ml-3 mr-3">|</small><small>{{trans('lang.advertisement_desc')}}</small></h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{!! route('operations.advertisement.index') !!}"><i class="fa fa-list mr-2"></i>{{trans('lang.advertisement_table')}}</a>
        </li>
        @endcan
        ...
        @endcan
        <li class="nav-item">
          <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-pencil mr-2"></i>{{trans('lang.advertisement_edit')}}</a>
        </li>
      </ul>
    </div>
    <div class="card-body">
      ...
      <div class="row">
        @include('operations.advertisement.fields')
      </div>
      {!! Form::close() !!}
      <div class="clearfix"></div>
    </div>
