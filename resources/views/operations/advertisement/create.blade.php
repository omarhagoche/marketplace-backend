  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        ...
        <li class="nav-item">
          <a class="nav-link {{ request()->routeIs('operations.advertisement.index') ? 'active' : '' }}" href="{!! route('operations.advertisement.index') !!}"><i class="fa fa-list mr-2"></i>{{trans('lang.advertisement_table')}}</a>
        </li>
        @endcan
        @can('operations.advertisement.create')
        <li class="nav-item">
          <a class="nav-link {{ request()->routeIs('operations.advertisement.create') ? 'active' : '' }}" href="{!! route('operations.advertisement.create') !!}"><i class="fa fa-plus mr-2"></i>{{trans('lang.advertisement_create')}}</a>
        </li>
        @endcan
      </ul>
    </div>
    <div class="card-body">
      {!! Form::open(['route' => 'operations.advertisement.store']) !!}
      <div class="row">
        @include('operations.advertisement.form_fields.create_fields')
      </div>
      {!! Form::close() !!}
      <div class="clearfix"></div>
    </div>
