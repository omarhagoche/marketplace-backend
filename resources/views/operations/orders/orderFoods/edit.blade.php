  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="{!!  url()->current() !!}"><i class="fa fa-shopping-basket mr-2"></i>{{trans('lang.order_edit_foods')}}</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="{!! route('orders.show-order-coupon',$orderId) !!}"><i class="fa fa-file mr-2"></i>{{trans('lang.coupon_plural')}}</a>
        </li>
      </ul>
    </div>
    <div class="card-body">
