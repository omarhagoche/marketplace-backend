  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{!! route('operations.orders.edit-order-foods',$order->id) !!}"><i class="fa fa-shopping-basket mr-2"></i>{{trans('lang.order_edit_foods')}}</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="{!! route('operations.orders.show-order-coupon',$order->id) !!}"><i class="fa fa-file mr-2"></i>{{trans('lang.coupon_plural')}}</a>
        </li>
      </ul>
    </div>
    <div class="card-body">
