...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <div class="form-group row ">
        ...
        <div class="col-9">
            {!! Form::text('name', null,  ['class' => 'form-control','required' => 'required','placeholder'=>  trans("lang.food_name_placeholder")]) !!}
...
<!-- Price Field -->
    <div class="form-group row ">
        ...
        <div class="col-9">
            {!! Form::number('price', null,  ['required' => 'required','class' => 'form-control','placeholder'=>  trans("lang.food_price_placeholder"),'step'=>"any", 'min'=>"0"]) !!}
            <div class="form-text text-muted">
    ...
    <div class="form-group row ">
        ...
        <div class="col-9">
            {!! Form::number('discount_price', null,  ['required' => 'required','class' => 'form-control','placeholder'=>  trans("lang.food_discount_price_placeholder"),'step'=>"any", 'min'=>"0"]) !!}
            <div class="form-text text-muted">
...
<div class="form-group col-12 text-right">
    ...
    <a href="{!! route('operations.restaurant_foods_index',$id) !!}" class="btn btn-default"><i class="fa fa-undo"></i> {{trans('lang.cancel')}}</a>
</div>
