...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">{{ trans('lang.restaurant') }}<small class="ml-3 mr-3">
                            {{ $restaurant->name }} </small></h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a
                                href="{!! route('restaurants.index') !!}">{{ trans('lang.restaurant_plural') }}</a>
                        </li>
        ...
        {!! Form::model($restaurant, ['route' => ['operations.restaurant_profile.update', $restaurant->id], 'method' => 'patch']) !!}
          <div class="row">
              ...
              <div class="col-md-8 col-12">
                  <div class="card">
                      @include(
                          'operations.restaurantProfile.links',
                          compact('id', 'restaurant')
                      )
                      <div class="card-body">
