...
class RestaurantReviewController extends Controller
{
    ...
    {
        return $restaurantReviewDataTable->render('operations.restaurant_reviews.index');
    }
    ...
    public function create()
    {
        ...
        return view('operations.restaurant_reviews.create')->with("customFields", isset($html) ? $html : false)->with("user", $user)->with("restaurant", $restaurant);
    }
    ...
    public function show($id)
    {
        ...
        return view('operations.restaurant_reviews.show')->with('restaurantReview', $restaurantReview);
    }
    ...
    public function edit($id)
    {
        ...
        return view('operations.restaurant_reviews.edit')->with('restaurantReview', $restaurantReview)->with("customFields", isset($html) ? $html : false)->with("user", $user)->with("restaurant", $restaurant);
    }
